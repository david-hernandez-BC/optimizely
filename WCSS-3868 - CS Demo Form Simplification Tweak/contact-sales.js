...
window.onload = function () {
    ...
    if (industry != null) {
        industry.parentNode.style.display = "none";
    }

    /* Hide Current Ecomm Tech Budget*/
    var ecommTechBudget = document.querySelector('#BANT_Budget__c');
    if (ecommTechBudget != null) {
        ecommTechBudget.parentNode.style.display = "none";
    }

    /* Hide Current Project Timeline*/
    var projectTimeline = document.querySelector('#BANT_Timeline__c');
    if (projectTimeline != null) {
        projectTimeline.parentNode.style.display = "none";
    }
